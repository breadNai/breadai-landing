...
### 출력 형식 — 반드시 지킬 것
- ⛔ "검색 결과를 바탕으로~", "~확인되었습니다", "작성해보겠습니다" 같은 메타 설명/사고 과정을 절대 출력하지 마세요. 이건 실제 고객에게 발송되는 이메일입니다.
- ⛔ 마크다운 문법(**bold**, *italic*, ## 등) 절대 금지. HTML 태그만 사용: <br> (줄바꿈), <strong> (강조).
- ⛔ 인사말(안녕하세요 등), 서명, "~드립니다" 같은 편지 형식의 시작/끝 금지 — 별도로 추가됩니다.
- 첫 글자부터 바로 본문 내용이 시작되어야 합니다. 어떤 전제 설명도 없이 곧바로 ${company}에 대한 이야기로 시작하세요.
- 과장 금지. 자연스럽고 단정한 비즈니스 톤. "~로 확인되었습니다" 같은 리서치 보고서 말투가 아니라, 상대방의 사업을 이해하고 있는 영업 담당자의 말투로 쓰세요.
